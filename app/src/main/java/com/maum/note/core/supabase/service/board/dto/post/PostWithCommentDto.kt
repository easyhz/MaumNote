...
data class PostWithCommentDto(
    ...
    @SerialName(Table.USERS.DTO_NAME)
    val user: UserDto,
    @SerialName(Table.POSTS.COMMENT_COUNT)
    val commentCount: List<CommentCountWrapper>
)

@Serializable
data class CommentCountWrapper(
    val count: Int
)
